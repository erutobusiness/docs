...
- 指摘
  - 愛？
    仕事の場に、そんな感情的でフワフワした概念を持ち込むのはプロフェッショナルではない - この発表では、愛を恋愛感情や感傷的な精神論と切り離している - あくまでチームの成果を最大化するため、エーリヒ・フロムが提唱した、極めて実践的で学習可能な技術として分析・解説している
...
- もちろん、常に業務時間の半分を他人のために使え、ということではない
  ...
  - 未来の自分を助けるための、合理的な先行投資
- 対応状況: **OK**
  - 対策箇所: 02-01-01配慮が欠けるとき
...
- 応答することと、すべてを受諾することは全く異なる
  - むしろ「要求がスコープ外」「リソース的に不可能」と、**理由を添えて誠実に、かつ速やかにNoと回答すること**も、相手の時間を無駄にしない、非常に重要な責任の形
- 対応状況: **OK**
  - 対策箇所: 02-03尊重（Respect）
...
- 尊重と放任は明確に異なる
  ...
  - 間違いに気づいた場合、命令形でこう直しなさいと指示しない - こういう問題が起きる可能性はないだろうか？
    と**問いかけ、相手自身に気づかせるアプローチ**を取ることが、尊重に基づいた関わり方である - これにより、相手の成長機会を奪わずに、品質も担保できる
- 対応状況: **OK**
  - 対策箇所: 02-03-01尊重が欠けるとき
    - 「尊重は放任とは違う」と明言
...
- 心臓や肺のように、どれか1つが欠けても全体が機能しないことを説明し、マニュアル的なアプローチが無意味であることを示した
- 対応状況: **OK**
  - 対策箇所： 02-05愛の4要素のまとめ
